...
FabricConfig parse_fabric_config(const std::string& config_str) {
    ...
    if (config_str == "FABRIC_2D_DYNAMIC") {
        return FabricConfig::FABRIC_2D_DYNAMIC;
    }
    if (config_str == "FABRIC_2D_DYNAMIC_TORUS_X") {
        return FabricConfig::FABRIC_2D_DYNAMIC_TORUS_X;
    }
    if (config_str == "FABRIC_2D_DYNAMIC_TORUS_Y") {
        return FabricConfig::FABRIC_2D_DYNAMIC_TORUS_Y;
    }
    if (config_str == "FABRIC_2D_DYNAMIC_TORUS_XY") {
        return FabricConfig::FABRIC_2D_DYNAMIC_TORUS_XY;
    }
...
std::string fabric_config_to_string(FabricConfig config) {
    switch (config) {
        ...
        case FabricConfig::FABRIC_2D_DYNAMIC: return "FABRIC_2D_DYNAMIC";
        case FabricConfig::FABRIC_2D_DYNAMIC_TORUS_X: return "FABRIC_2D_DYNAMIC_TORUS_X";
        case FabricConfig::FABRIC_2D_DYNAMIC_TORUS_Y: return "FABRIC_2D_DYNAMIC_TORUS_Y";
        case FabricConfig::FABRIC_2D_DYNAMIC_TORUS_XY: return "FABRIC_2D_DYNAMIC_TORUS_XY";
