...
uint32_t all_gather_async_core_count_per_link_1mux(
    ...
    log_info(
        tt::LogOp,
        "all_gather_async_core_count_per_link num_workers_per_direction: {}, num_directions_per_link: {}, num_mux_cores_per_direction_per_link: {}",
...
tt::tt_metal::operation::ProgramWithCallbacks all_gather_async_minimal_default_helper(
    ...
    auto mux_1 = false;
    auto func_p = mux_1 ?
        build_all_gather_async_minimal_default_program_artifacts_1mux :
        build_all_gather_async_minimal_default_program_artifacts;
    auto func_override = mux_1 ?
        all_gather_async_minimal_default_helper_override_runtime_arguments_1mux :
