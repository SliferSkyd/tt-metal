...
class resnetBlock2D:
    def __init__(
        ...
        self.conv1_in_channels = in_channels
        ...
        self.conv1_weights = ttnn.from_torch(split_weight_tensors[0], ttnn.float32)
        ...
        if (out_channels, in_channels, input_height, input_width) in config_override:
            self.conv2_config_override = config_override[(out_channels, in_channels, input_height, input_width)]
    ...
    def __call__(
        ...
        *,
        ...
        [hidden_states, [prepared_weights, prepared_bias]] = ttnn.conv2d(
        ...
        self.conv1_weights = prepared_weights
        self.conv1_bias = prepared_bias
        ...
        if temb is not None and time_embedding_norm == "default":
            ...
            hidden_states = ttnn.reshape(
                hidden_states,
                (self.batch_size, 1, self.conv1_input_height * self.conv1_input_width, hidden_states.shape[-1]),
            )
        ...
        self.conv2_weights = prepared_weights
        self.conv2_bias = prepared_bias
        ...
        if use_in_shortcut:
            ...
            [input_tensor, [prepared_weights, prepared_bias]] = ttnn.conv2d(
            ...
            self.conv_shortcut_weights = prepared_weights
            self.conv_shortcut_bias = prepared_bias

        if ttnn.get_memory_config(input_tensor) != ttnn.get_memory_config(hidden_states):
            hidden_states = ttnn.to_memory_config(hidden_states, ttnn.get_memory_config(input_tensor))
