...
def multi_scale_deformable_attn_ttnn(
    ...
    for lvl in range(num_levels):
        ...
        value_l_torch = ttnn.to_torch(value_l, dtype=torch.float32)
        ...
        sampled_ttnn = ttnn.from_torch(sampled, device=device, dtype=ttnn.bfloat16)
        ...
        print("sampled_permuted.shape", sampled_permuted.shape)
        ...
        print("level_output.shape", level_output.shape)
