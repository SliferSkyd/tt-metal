...
def test_decoder_inference(
    ...
    for i in range(generation_length):
        ...
        logger.info(f"DEBUG PRINT: model_args.sliding_window: {model_args.sliding_window}")
        logger.info(f"DEBUG PRINT: reference_model.attention_type: {reference_model.attention_type}")
