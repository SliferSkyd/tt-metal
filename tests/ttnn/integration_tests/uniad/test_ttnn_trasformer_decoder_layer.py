...
def custom_preprocessor(model, name):
    parameters = {}
    if isinstance(model, nn.TransformerDecoderLayer):
        parameters["self_attn"] = model.self_attn
        parameters["multihead_attn"] = model.multihead_attn
        ...
        parameters["norm3"] = {}
        parameters["norm3"]["weight"] = preprocess_layernorm_parameter(model.norm3.weight, dtype=ttnn.bfloat16)
        parameters["norm3"]["bias"] = preprocess_layernorm_parameter(model.norm3.bias, dtype=ttnn.bfloat16)
