            ...
            with open(trace_file, "r") as nocTraceJson:
                ...
                for event in noc_trace_data:
                    ...
                    if event.get("type", "").startswith("FABRIC_"):
                        ...
                        assert fabric_send_metadata.get("x", None) is not None
                        assert fabric_send_metadata.get("y", None) is not None
                        assert fabric_send_metadata.get("noc", None) is not None
